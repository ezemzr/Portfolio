...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_3mqq70d', 'template_x3u31b9', e.target, '')
    ...
    return (
        <div className='contact__section section__margin' id='contact'>
            ...
            <div className='contact__icons'>
                <a href='https://www.linkedin.com/in/ezequielminzer/' target='_blank'><RiLinkedinBoxFill color='white' size={25} type='button' className='btn__linkedin'></RiLinkedinBoxFill></a>
                <a href='https://github.com/ezemzr' target='_blank'><RiGithubFill color='white' size={25} type='button' className='btn__github'>Gith</RiGithubFill></a>
